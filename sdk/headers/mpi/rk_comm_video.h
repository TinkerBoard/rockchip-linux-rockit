...
typedef struct rkVIDEO_FRAME_S {
    ...
    RK_S16              s16OffsetTop;        /* top offset of show area */
    RK_S16              s16OffsetBottom;    /* bottom offset of show area */
    RK_S16              s16OffsetLeft;        /* left offset of show area */
    RK_S16              s16OffsetRight;        /* right offset of show area */
